...
public class TestData {
	...
	List<Book> allBooks = new ArrayList<Book>() {
		{
			add(new Book("2311451123", "The Big Fish", 21, Arrays.asList(allAuthors.get(0), allAuthors.get(1))));
			add(new Book("2812331456", "Antartica", 7, Arrays.asList(allAuthors.get(2))));
			add(new Book("9922223789", "Thinking Java", 21, Arrays.asList(allAuthors.get(3))));
			add(new Book("4856882567", "Jimmy's First Day of School", 7, Arrays.asList(allAuthors.get(4))));
		}
	};
